...
class AboutSectionPolicy
{
     ...
     */
    public function forceDelete(User $user, AboutSection $aboutSection): bool
    {
     ...
     */
    public function restore(User $user, AboutSection $aboutSection): bool
    {
     ...
     */
    public function replicate(User $user, AboutSection $aboutSection): bool
    {
